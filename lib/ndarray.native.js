...
*
* var z = dkmeansDistance( x.length, 'sqeuclidean', x, 1, 0, y, 1, 0 );
* // returns 72.0
*/
function dkmeansDistance( N, metric, x, strideX, offsetX, y, strideY, offsetY ) {
	...
	return addon.ndarray( N, v, x, strideX, offsetX, y, strideY, offsetY );
}
